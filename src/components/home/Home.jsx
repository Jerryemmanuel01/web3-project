  ...
  return (
    ...
    >
      <motion.div
        ...
        className="text-center w-full flex flex-col justify-center items-center md:mt-16 lg:mt-40"
      >
        ...
        <p className="font-bold font- text-sm md:text-base lg:text-lg mt-3">
          CA: C4XE2X23NJXLJFRF234K42O75N5XSD
        </p>
      </motion.div>
